...
from core.process_utils import build_process_clone_payload, get_process_log_payload, inspect_process_payload
from models.schemas import ProcessCloneDraftResponse
...
@process_router.get("/{identifier}/clone-draft", response_model=ProcessCloneDraftResponse)
def clone_process_draft(identifier: str) -> ProcessCloneDraftResponse:
    ensure_profile_loaded()
    return ProcessCloneDraftResponse(**build_process_clone_payload(identifier))
